...
export const CARDS = [
  ...
  },
  {
    ...
    note: 'Строка «Compared with» вернулась, и это правка по слову владельца: без неё не видно, против какого дня посчитано ▼337. Она стоит вплотную к названию, в шапке, и печатается всегда; если за вчера снимка нет, она прямо говорит и это — «2026-08-20 — the days between have no data». У недельной карточки в ней стоит диапазон прошлой недели. Стрелка сравнения теперь у КАЖДОГО числа. Раньше она стояла у одного — у серверного лога, — и читалась как случайность; владелец справедливо спросил, почему в других местах не видно, сколько было вчера. Данные для сравнения были у всех, просто считал я только одно число. У доли «Visible» стрелка в процентных пунктах, в тех же единицах, что и само число. То же самое в недельной карточке: там не было ни одной стрелки, потому что прошлая неделя вообще не читалась — теперь читается, а неделя без единого снимка базой не служит, «нечего сравнивать» это не «ноль». Строки «Compared with» здесь больше нет. У дневного отчёта база сравнения — вчера, каждый день, поэтому строка каждый день говорила одно и то же и занимала место. Смысл в ней появляется ровно в одном случае: за вчера снимка нет — сервер лежал или крон не отработал, — и стрелки ▲ посчитаны от позавчера. Тогда строка возвращается и говорит об этом прямо: «Compared with: 2026-08-19 — the days between have no data». У недельного отчёта она была просто неверной: сравнение там с прошлой неделей, а в строку подставлялся соседний ДЕНЬ. Источник числа теперь заголовок группы, а не хвост ярлыка: было «GA4 users», «Google clicks», «Humans in the server log» — три способа приписать источник к ярлыку; стало четыре группы и короткие ярлыки. Поисковый запрос внизу стоял через тире — «игры для мальчиков — 4 clicks». Тире делало работу двоеточия, а третьего знака препинания в формате быть не должно: запрос теперь ярлык, как и всё остальное. Значок 💡 у ярлыка ушёл по той же причине — ярлык это слово. А сами поисковые запросы переехали в именованную группу: запрос по-русски остаётся по-русски, это набрал живой человек, но заголовок группы английский и говорит, что это за строки — иначе русский запрос читался как русский ярлык. Ссылка переехала с отдельной строки «Details: open» на само название отчёта. И тег: раньше отчёт не передавал ключ, поэтому тег собирался из заголовка с датой и был новым КАЖДЫЙ день — пара «сломалось → починилось» по нему не находилась никогда. Теперь ключ постоянный.'
  },
  {
