...
export const CARDS = [
  ...
  },
  {
    ...
    note: "Вторая строка — заголовок задачи, номер ушёл вниз и стал самой ссылкой: Source: #322. Что случилось, говорит значок: 🆕 завели, 🙋 назначили, ✅ закрыли. Тело идёт сразу под заголовком, люди — отдельным блоком ниже."
  },
  {
