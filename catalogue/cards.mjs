...
export const CARDS = [
  ...
  },
  {
    ...
    note: 'Серая цитата — это тело коммита, и она появляется, только если автор его написал. Твой скриншот был короче именно поэтому: у того коммита тела не было, и цитировать было нечего. С 25.08.2026 такие коммиты в 21 репозитории машины просто не создаются — гард не даёт закоммитить без тела. Остаться карточка без цитаты может от коммита, сделанного мимо этой машины: слияние кнопкой на GitHub, чужой коммит, коммит старше гарда.'
  },
  {
