...
export const CARDS = [
  {
    ...
    note: "Чем выкатили — сама вторая строка; раньше один факт был разрезан натрое: слово «ok», строка «Via» под ним и «Workflow» в самом низу. Ссылка на прогон стоит внизу отдельной строкой Source: указатель, который видно, вместо ссылки, спрятанной на имени."
  },
  {
