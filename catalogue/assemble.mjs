...
<div class="wrap">
  ...
  <section class="block" id="types">
    ...
    <ul class="rules">
      <li><b>Строка 1 — три тега</b><span>Что за событие, где и чем кончилось. Третий тег — твой фильтр, и слов в нём пять: <code>#ok</code>, <code>#fail</code>, <code>#off</code> (выключено, не сломалось), <code>#unknown</code> (молчит, живо оно или нет — неизвестно), <code>#news</code>.</span></li>
