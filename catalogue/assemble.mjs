...
<div class="wrap">
  ...
  <section class="block" id="types">
    ...
    <ul class="rules">
      ...
      <li><b>Число — сегодня, косая, вчера, потом сдвиг</b><span><code>51 / 46 ▲5</code>: сейчас 51, вчера было 46, выросло на 5. Сравнивать не с чем — стоит просто число, без косой и без стрелки. Тот же знак и в скобке у имени отчёта: <code>(2026-08-23 / 2026-08-22)</code>.</span></li>
