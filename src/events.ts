 ...
 * регулярные отправители передают его явно. В вывод CLI (stderr, и его же
 * сторож на VPS читает объединённым потоком по словам `sent|failed|skipped`)
 * ключ не попадает никогда — новое слово там ослепило бы сторожа.
 */
